...
class AccesoBaseDatos
{
	...
	{
		$dsn=CONFIG::getInstancia()->driver.":host=".CONFIG::getInstancia()->host.";dbname=".CONFIG::getInstancia()->database;
		$this->CrearConexion($dsn,CONFIG::getInstancia()->usuario,CONFIG::getInstancia()->contrasena);
	}
